...
A few months ago I made Kawaii Tank Miniature, a simple top-view racing game. Then, I got the idea of training an AI to race on it. But it was terrible and I encountered an absurd amount of bugs which made me give up for a while. Then I decided to use Claude to fix most of these bugs, and I watched some tutorials to better understand what the hell I was supposed to do. And it finally worked, so after a lot of tweaks, I was finally able to make the AI accomplish a full clean lap.
